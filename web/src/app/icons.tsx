...
/* ==========================================
   Refresh/Sync Data in Vaults and History pages
   ========================================== */
...
/* ==========================================
   Wheel Interface Panel Icons
   ========================================== */

export function DepositIcon({ className = '' }) {
  return (
...
export function WithdrawIcon({ className = '' }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <g id="_17._Withdraw">
...
export function SendIcon({ className = '' }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 158 134" xmlns="http://www.w3.org/2000/svg">
...
export function CreateIcon({ className = '' }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 442 442" xmlns="http://www.w3.org/2000/svg">
...
export function ReceiveIcon({ className = '' }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      <g id="_28._Saving">
...
export function ShieldEmblemIcon({ className = '' }) {
  return (
